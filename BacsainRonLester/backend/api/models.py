...
class Item(models.Model):
    first_name = models.CharField(max_length=100, default='Ron Lester')
    middle_name = models.CharField(max_length=100, default='Babol')
    last_name = models.CharField(max_length=100, default='Bacsain')
